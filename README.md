...
vendored at `05-cs336/assignment1-basics/`, implementations go in its `cs336_basics/`, wired through `tests/adapters.py`. `uv run pytest` is the ground truth — 48 tests. Plan, deltas from Karpathy, and the running score: `05-cs336/PLAN.md`.
